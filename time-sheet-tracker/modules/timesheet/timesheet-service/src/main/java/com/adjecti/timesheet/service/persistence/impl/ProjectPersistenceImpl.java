...
import com.adjecti.timesheet.model.impl.ProjectImpl;
import com.adjecti.timesheet.model.impl.ProjectModelImpl;
...
public class ProjectPersistenceImpl
	...
	/**
	 * Returns all the projects where projectId = &#63;.
	 *
	 * @param projectId the project ID
	 * @return the matching projects
	 */
	@Override
	public List<Project> findByProjectId(long projectId) {
		return findByProjectId(
			projectId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the projects where projectId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ProjectModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Project> findByProjectId(long projectId, int start, int end) {
		return findByProjectId(projectId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the projects where projectId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ProjectModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Project> findByProjectId(
	...
	/**
	 * Returns the first project in the ordered set where projectId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching project
	 ...
	 */
	@Override
	public Project findByProjectId_First(
			long projectId, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchByProjectId_First(projectId, orderByComparator);
	 ...
	 */
	@Override
	public Project fetchByProjectId_First(
		long projectId, OrderByComparator<Project> orderByComparator) {

		List<Project> list = findByProjectId(
	...
	/**
	 * Returns the last project in the ordered set where projectId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching project
	 ...
	 */
	@Override
	public Project findByProjectId_Last(
			long projectId, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchByProjectId_Last(projectId, orderByComparator);
	 ...
	 */
	@Override
	public Project fetchByProjectId_Last(
		long projectId, OrderByComparator<Project> orderByComparator) {
	...
	/**
	 * Removes all the projects where projectId = &#63; from the database.
	 *
	 * @param projectId the project ID
	 */
	@Override
	...
	public Project updateImpl(Project project) {
		...
		if (isNew) {
			...
			args = new Object[] {projectModelImpl.getProjectId()};
			...
			if ((projectModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					projectModelImpl.getOriginalProjectId()
				};
