...
/**
 * The implementation of the task category local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.adjecti.timesheet.service.TaskCategoryLocalService</code> interface.
 *
 * <p>
 ...
 * @see TaskCategoryLocalServiceBaseImpl
 */
@Component(
	property = "model.class.name=com.adjecti.timesheet.model.TaskCategory",
	service = AopService.class
)
public class TaskCategoryLocalServiceImpl
	extends TaskCategoryLocalServiceBaseImpl {
