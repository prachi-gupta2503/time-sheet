...
import com.adjecti.timesheet.model.impl.TaskImpl;
import com.adjecti.timesheet.model.impl.TaskModelImpl;
...
public class TaskPersistenceImpl
	...
	public void clearCache(Task task) {
		entityCache.removeResult(TaskImpl.class, task.getPrimaryKey());
	...
	public Task updateImpl(Task task) {
		...
		if (isNew) {
			...
			if ((taskModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					taskModelImpl.getOriginalTaskId()
				};
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll",
			new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathWithPaginationFindByUuid = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
		...
		_finderPathFetchByUUID_G = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
		...
		_finderPathWithoutPaginationFindByTaskId = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByTaskId", new String[] {Long.class.getName()},
			TaskModelImpl.TASKID_COLUMN_BITMASK);

		_finderPathCountByTaskId = new FinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByTaskId", new String[] {Long.class.getName()});
	}
