...
import com.adjecti.timesheet.model.impl.EmployeeImpl;
import com.adjecti.timesheet.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	public void clearCache(Employee employee) {
		entityCache.removeResult(EmployeeImpl.class, employee.getPrimaryKey());
	...
	public Employee updateImpl(Employee employee) {
		...
		if (isNew) {
			...
			finderCache.removeResult(_finderPathCountByEmployeeId, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByEmployeeId, args);
			...
			if ((employeeModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByEmployeeId.
					 getColumnBitmask()) != 0) {
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindAll = new FinderPath(
			EmployeeImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			EmployeeImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
		...
		_finderPathCountByEmployeeId = new FinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByEmployeeId", new String[] {Long.class.getName()});
	}
