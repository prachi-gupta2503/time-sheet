...
/**
 * The implementation of the task category remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.adjecti.timesheet.service.TaskCategoryService</code> interface.
 *
 * <p>
 ...
 * @see TaskCategoryServiceBaseImpl
 */
@Component(
	property = {
		"json.web.service.context.name=timesheet",
		"json.web.service.context.path=TaskCategory"
	},
	service = AopService.class
)
public class TaskCategoryServiceImpl extends TaskCategoryServiceBaseImpl {
